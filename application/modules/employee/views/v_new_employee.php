        ...
        <div class="">
          ...
          <div class="">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-bars"></i> New <small>Employee</small></h2>
					  ...
					  <form id="frm_new_emp" name="frm_new_emp">
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-3">
								<img src="<?php echo base_url('pds_image/default-pictures.jpg'); ?>" style="width:200px;height:200px;" class="hoverZoomLink">
							...
							<div class="col-md-9 col-sm-9"><hr></div>
								...
								<label class="form-label">Employee No.: </label>
									<input type="text" id="a_empno" name="a_empno" class="form-control col-md-4" value="" >
								</div>
								<div class="col-md-2">
									<label class="form-label">FDOS: </label>
									<input type="text" id="a_fdos" name="a_fdos" class="date form-control col-md-4" value="" >
								</div>
								<div class="col-md-2">
								...
								<div class="col-md-2">
									...
									<input type="text" id="a_machineid" name="a_machineid" class="form-control col-md-4 numeric" value="">
								</div>
								<div class="col-md-2">
								...
								<div class="col-md-2">
									...
									<input type="text" id="a_hielig" name="a_hielig" class="form-control col-md-4" value="">
								</div>
								<div class="col-md-3">
									<label class="form-label">Highest Education: </label>
									<input type="text" id="a_hieduc" name="a_hieduc" class="form-control col-md-4" value="">
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<hr>
								...
								<div class="col-md-3">
									<input type="text" id="a_firstname" name="a_firstname" class="form-control" value="">
								</div>
								<div class="col-md-3">
									<input type="text" id="a_middlename" name="a_middlename" class="form-control col-md-4" value="">
								</div>
								<div class="col-md-2">
									<input type="text" id="a_mi" name="a_mi" class="form-control col-md-4" value="" >
								</div>
								<div class="col-md-3">
									<input type="text" id="a_lastname" name="a_lastname" class="form-control col-md-4" value="" >
								</div>
								<div class="col-md-1">
									<input type="text" id="a_namext" name="a_namext" class="form-control col-md-4" value="" >
								</div>
							</div>
						</div>
						<br/>
						<div class="row">
							<div class="col-md-12">
								<div class="col-md-2">
									...
									<input type="text" id="pi_birthdate" name="pi_birthdate" class="date form-control" value="">
								</div>
								<div class="col-md-4">
									<label class="form-label">Place of Birth: </label>
									<input type="text" id="pi_birthplace" name="pi_birthplace" class="form-control" value="">
								</div>
								<div class="col-md-2">
								...
								<div class="col-md-2">
									...
									<input type="text" id="pi_citizenship" name="pi_citizenship" class="form-control" value="">
								</div>
							</div>
						</div>
						<br/>
						<div class="row">
							<div class="col-md-12">
								<div class="col-md-1">
									...
									<input type="text" id="pi_height" name="pi_height" class="form-control" value="" >
								</div>
								<div class="col-md-1">
									<label class="form-label">Weight: </label>
									<input type="text" id="pi_weight" name="pi_weight" class="form-control" value="">
								</div>
								<div class="col-md-2">
									<label class="form-label">Blood Type: </label>
									<input type="text" id="pi_bloodtype" name="pi_bloodtype" class="form-control" value="" >
								</div>
								<div class="col-md-2">
									<label class="form-label">GSIS No.: </label>
									<input type="text" id="pi_gsis" name="pi_gsis" class="form-control" value="">
								</div>
								<div class="col-md-2">
									<label class="form-label">PAG-IBIG ID NO.: </label>
									<input type="text" id="pi_pagibig" name="pi_pagibig" class="form-control" value="">
								</div>
								<div class="col-md-2">
									<label class="form-label">PHILHEALTH NO.: </label>
									<input type="text" id="pi_philhealth" name="pi_philhealth" class="form-control" value="" >
								</div>
								<div class="col-md-2">
									<label class="form-label">SSS NO.: </label>
									<input type="text" id="pi_sss" name="pi_sss" class="form-control" value="" >
								</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="col-md-2">
									...
									<input type="text" id="pi_resstreet" name="pi_resstreet" class="form-control" value="">
								</div>
								<div class="col-md-2">
									<label class="form-label">Barangay: </label>
									<input type="text" id="pi_resbrgy" name="pi_resbrgy" class="form-control" value="" >
								</div>
								<div class="col-md-3">
									<label class="form-label">City: </label>
									<input type="text" id="pi_rescity" name="pi_rescity" class="form-control" value="" >
								</div>
								<div class="col-md-2">
									<label class="form-label">Province: </label>
									<input type="text" id="pi_resprov" name="pi_resprov" class="form-control" value="" >
								</div>
								<div class="col-md-1">
									<label class="form-label">Zip: </label>
									<input type="text" id="pi_reszip" name="pi_reszip" class="form-control" value="" >
								</div>
								<div class="col-md-2">
									<label class="form-label">Contact No.: </label>
									<input type="text" id="pi_resphone" name="pi_resphone" class="form-control" value="" >
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-2">
								...
								<div class="col-md-2">
									<label class="form-label">Street: </label>
									<input type="text" id="pi_permstreet" name="pi_permstreet" class="form-control" value="" >
								</div>
								<div class="col-md-2">
									<label class="form-label">Barangay: </label>
									<input type="text" id="pi_permbrgy" name="pi_permbrgy" class="form-control" value="" >
								</div>
								<div class="col-md-3">
									<label class="form-label">City: </label>
									<input type="text" id="pi_permcity" name="pi_permcity" class="form-control" value="">
								</div>
								<div class="col-md-2">
									<label class="form-label">Province: </label>
									<input type="text" id="pi_permprov" name="pi_permprov" class="form-control" value="">
								</div>
								<div class="col-md-1">
									<label class="form-label">Zip: </label>
									<input type="text" id="pi_permzip" name="pi_permzip" class="form-control" value="">
								</div>
								<div class="col-md-2">
									<label class="form-label">Contact No.: </label>
									<input type="text" id="pi_permphone" name="pi_permphone" class="form-control" value="" >
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<hr/>
								<div class="col-md-3">
									...
									<input type="text" id="pi_email" name="pi_email" class="form-control" value="" >
								</div>
								<div class="col-md-2">
									<label class="form-label">Cellphone No. (if any): </label>
									<input type="text" id="pi_phone" name="pi_phone" class=" form-control" value="" >
								</div>
								<div class="col-md-2">
									<label class="form-label">Tin No.: </label>
								
									<input type="text" id="pi_tin" name="pi_tin" class="form-control" value="" >
								</div>
							</div>
						</div>
