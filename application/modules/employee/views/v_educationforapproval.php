            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <table class="cell-border" id="datatable_employee_education">
                    <thead>
                      <tr>
...
<!-- Delete Educ -->
<div class="modal fade" id="frm_approval_confirmation_education" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="frm_educationapproved" name="frm_educationapproved" method="post" action="#">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<input type="hidden" id="m_pi_forapproval" name="m_pi_forapproval" class="m_pi_forapproval" value="">
                </div>
