                        ...
                        <div class="form-horizontal row filter">
                            ...
                            <div class="form-group col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12" id="filter_col1" data-column="0">
                                    <input type="text" class="column_filter form-control" id="col0_filter" autocomplete="on">
                                </div>
                            </div>
                        ...
                        <table id="datatable_employee" class="cell-border compact hover" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Pag-ibig</th>
                                    <th>SSS</th>
                                    <th style="min-width: 30px;">M-ID</th>
                                    <th style="min-width: 30px;">a_id</th>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<input type="button" id="btn_resetpassword" name="btn_resetpassword" class="btn btn-warning form-control" value="Reset Password?" onclick="resetpassword()">
        </div>
      </div>
    </div>
</div>
...
<div class="modal fade" id="resetpassword" tabindex = "-1" role = "dialog" aria-hidden = "true">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h5 class="modal-title">Do you really want to reset his/her password?</h5>
        </div>
        <!--div class="modal-body">
		...
		<div class="btn-group col-md-12 col-lg-12 col-sm-12 col-xs-12">
							<button id="btn_no" name="btn_no" class="btn btn-warning col-md-6 col-lg-6 col-sm-6 col-xs-6">No</button>
							<button id="btn_yes" name="btn_yes" class="btn btn-success col-md-6 col-lg-6 col-sm-6 col-xs-6">Yes</button>
						</div>
        </div>
      </div>
    </div>
