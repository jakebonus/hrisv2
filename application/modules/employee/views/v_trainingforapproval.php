            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <table class="cell-border" id="datatable_employee_training">
                    <thead>
                      <tr>
...
<!-- Delete Educ -->
<div class="modal fade" id="frm_approval_confirmation_training" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="frm_trainingapproved" name="frm_trainingapproved" method="post" action="#">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<input type="hidden" id="m_t_forapproval" name="m_t_forapproval" class="m_t_forapproval" value="">
                </div>
