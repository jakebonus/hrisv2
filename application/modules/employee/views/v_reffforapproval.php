            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <table class="cell-border" id="datatable_employee_reffapproved">
                    <thead>
                      <tr>
                        ...
                        <th>Department</th>
                        <th>Status</th>
                        <th>Character Reference Name</th>
                        <th>Character Reference Contact No.</th>
                        <th>Remarks</th>
                        <th>Action</th>
                      </tr>
                    </thead>
...
<!-- Delete Educ -->
<div class="modal fade" id="frm_approval_confirmation_reff" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="frm_reffapproved" name="frm_reffapproved" method="post" action="#">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<input type="hidden" id="m_r_forapproval" name="m_r_forapproval" class="m_r_forapproval" value="">
                </div>
