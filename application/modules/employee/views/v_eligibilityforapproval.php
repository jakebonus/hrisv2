            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <table class="cell-border" id="datatable_employee_eligibility">
                    <thead>
                      <tr>
...
<!-- Delete Educ -->
<div class="modal fade" id="frm_approval_confirmation_eligibility" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="frm_eligibilityapproved" name="frm_eligibilityapproved" method="post" action="#">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<input type="hidden" id="m_el_forapproval" name="m_el_forapproval" class="m_el_forapproval" value="">
                </div>
