            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <table class="cell-border" id="datatable_employee_children">
                    <thead>
                      <tr>
...
<!-- Delete Educ -->
<div class="modal fade" id="frm_approval_confirmation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="frm_childapproved" name="frm_childapproved" method="post" action="#">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<input type="hidden" id="m_c_forapproval" name="m_c_forapproval" class="m_c_forapproval" value="">
                </div>
