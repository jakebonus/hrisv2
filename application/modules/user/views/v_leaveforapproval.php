                ...
                <div class="modal-footer">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="col-sm-12">
								<button type="button" class="btn btn-warning" id="btn_leaveForApprovalClosedModal" data-dismiss="modal">Close</button>
								<button id="btn_approve" name="btn_approve" type="button" class="btn btn-success pull-right" > Approve</button>
							</div>
						</div>
					</div>
                </div>
...
-->				
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-warning" id="btn_leaveForApprovalClosedModal_disapproved" data-dismiss="modal">Close</button>
