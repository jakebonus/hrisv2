            ...
            <div class="menu_section">
				...
				<ul class="nav side-menu">
                    <li><a><i class="fa fa-briefcase"></i> Placement <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a target="_blank" href="<?php echo base_url('onlineapplicant/listofapplicants'); ?>">Applicant's Database</a></li>
							<!--li>
                            ...
                            <li>
                                   <a>Personnel Requests<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="">
                                       <li class="sub_menu">
                                           <a target="_blank" href="<?php echo base_url('onlineapplicant/job_matching'); ?>">Encode Request</a>
                                        </li>
                                        <li class="sub_menu">
                                            <a target="_blank" href="<?php echo base_url('onlineapplicant/requestlist'); ?>">Request List and Approval</a>
                                        </li>
                                      </ul>
                                </li>
							
							
							<li><a target="_blank" href="<?php echo base_url('rankingposition/filter_candidate'); ?>">SRP</a></li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <li><a><i class="fa fa-pencil"></i> For Approval <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
						   ...
						   <li>
							...
							<li><a target="_blank" href="<?php echo base_url('onlineapplicant/appointments'); ?>">Applicant's Database</a></li>
                        </ul>
                    </li>
				<?php }?>
                </ul>
                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-wrench"></i> Maintenance <span class="fa fa-chevron-down"></span></a>
						...
						?>
							...
							<li><a  target="_blank" href="<?php echo base_url('onlineapplicant/courses'); ?>">Courses</a></li>
							<li><a  target="_blank" href="<?php echo base_url('rankingposition/qualitystandards'); ?>">Quality Standards</a></li>
