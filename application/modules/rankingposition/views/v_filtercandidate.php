        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">.
                        <div class="row">
							<form id="frm_rp" name="frm_rp">

							<div class="row">
								<div class="form-group col-xs-2">
									<label class="control-label col-xs-12">Office</label>
										<select class="form-control" id="rp_office" name="rp_office" >
											<option value="">-- Choose --</option>
										</select>
								</div>
								<!--div class="form-group col-xs-2">
									<label class="control-label col-xs-12">Division</label>
										<select class="form-control" id="rp_div" name="rp_div">
											<option value=""> Choose </option>
										</select>
								</div-->
								<div class="form-group col-xs-3">
									<label class="control-label col-xs-12">Position</label>
										<select class="form-control" id="rp_position" name="rp_position" >
											<option value="">-- Choose --</option>
										</select>
								</div>
								<div class="form-group col-xs-3">
									<label class="control-label col-xs-12">Parenthetical</label>
									<div id="rp_parent" name="rp_parent"> </div>
								</div>
								<div class="form-group col-xs-1">
									<label class="control-label col-xs-12">SG</label>
									<div id="rp_sg" name="rp_sg"> </div>
								</div>
								<div class="form-group col-xs-1">
									<label class="control-label col-xs-12">Level</label>
									<div id="rp_level" name="rp_level"> </div>
								</div>
                            </div>
							...
							<div class="row">
								<div class="form-group col-xs-3">
									<div class="x_panel">
										<label class="control-label col-xs-12"><u><center>EDUCATION</center></u></label>
										<hr>
										<div id="rp_educ" name="rp_educ"> </div>
									</div>
								</div>
								<div class="form-group col-xs-3">
									<div class="x_panel">
										<label class="control-label col-xs-12"><u><center>WORK EXPERIENCE</center></u></label>
										<hr>
										<div id="rp_work" name="rp_work"> </div>
									</div>
								</div>
								<div class="form-group col-xs-3">
									<div class="x_panel">
										<label class="control-label col-xs-12"><u><center>TRAINING</center></u></label>
										<hr>
										<div id="rp_training" name="rp_training"> </div>
									</div>
								</div>
								<div class="form-group col-xs-3">
									<div class="x_panel">
										<label class="control-label col-xs-12"><u><center>ELIGIBILITY</center></u></label>
										<hr>
										<div id="rp_eligibility" name="rp_eligibility"> </div>
									</div>
								</div>
                            </div>
							<!--div class="form-group col-xs-4">
                                <label class="control-label col-xs-12">Eligibility</label>
                                <input type="text" class="form-control" id="rp_eligibility" name="rp_eligibility" readonly>
                            </div>
							<div class="form-group col-xs-3">
                                <label class="control-label col-xs-12">Education</label>
                                <input type="text" class="form-control" id="rp_educ" name="rp_educ" readonly>
                            </div>
							<div class="form-group col-xs-2">
                                <label class="control-label col-xs-12">Sector</label>

                                <input type="text" class="form-control" id="rp_educ_sector" name="rp_educ_sector" readonly>

                            </div>
							<div class="form-group col-xs-3">
                                <label class="control-label col-xs-12">Relevance</label>

                                <input type="text" class="form-control" id="rp_relevance" name="rp_relevance" readonly>

                            </div>
							<div class="form-group col-xs-2">
                                <label class="control-label col-xs-12">Experience Years</label>

                                <input type="text" class="form-control" id="rp_exp_years" name="rp_exp_years" readonly>

                            </div>

							<div class="form-group col-xs-2">
                                <label class="control-label col-xs-12">Training Hourse</label>
                                <input type="text" class="form-control" id="rp_hrs" name="rp_hrs" readonly>
                            </div-->
							</form>
                        </div>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					...
					<style>
                        ...
                        <table id="dt_rankingpositioncadidates" class="cell-border compact hover" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>Name</th>
									<th>Position</th>
