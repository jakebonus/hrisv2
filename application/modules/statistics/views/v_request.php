					...
					<?php
						...
						<div class="row">
							<div class="col-sm-3">
								...
								<select disabled class="form-control" id="r_type" name="r_type">
							...
							<div class="col-sm-1">
								...
								<input readonly  type="text" maxlength="1" class="numeric form-control" id="r_noofcopy" name="r_noofcopy" > 
							</div>
							<div class="col-sm-4">
								<label class="form-label">Purpose:</label>
								<input readonly  type="text" class="form-control" id="r_purpose" name="r_purpose" > 
							</div>
							<div class="col-sm-2">
