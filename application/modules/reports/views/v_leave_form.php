...
<table class="tg" style="max-width:560px;">
  <tr>
    <th class="tg-e3zv" colspan="20">CSC Form 6<br>Revised 1984</th>
  </tr>
  <tr>
    <th class="tg-e3zv b_bottom" colspan="20"><center>APPLICATION FOR LEAVE</center></th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-093g b_left b_bottom" colspan="3"><?php echo $a_lastname.' '.$a_namext; ?></td>
  ...
  <tr>
    <td class="tg-baqh name3" colspan="20" style="padding-top:30px!important;">
      ...
      <span style='z-index:9;position:relative;line-height:1;'><strong><?php echo $asmayor_name?></strong> <br/>
        <?php if ($m_position == "CITY MAYOR") { 
          echo $m_position;
        } else if($m_position == "CITY VICE MAYOR"){
           echo $m_position;
         }else { ?>
        City Administrator
        <?php } ?>
  ...
  <tr>
    <td class="tg-p_left_b" colspan="10">DATE: <?php echo '<u>'.date('F d, Y').'</u>'; ?></td>
    <td class="tg-p_left"></td>
    <td class="tg-p_left"></td>
    <td class="tg-p_left"></td>
    <td class="tg-p_left"></td>
